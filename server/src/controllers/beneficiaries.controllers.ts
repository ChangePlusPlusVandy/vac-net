...
import BeneficiaryModel from '../models/BeneficiaryModel'; // Assuming Beneficiary is a Mongoose model
...
const deleteBeneficiary = async (req: Request, res: Response): Promise<void> => {
    const beneficiaryId = req.query?._id;
    try {
        if (beneficiaryId) {
